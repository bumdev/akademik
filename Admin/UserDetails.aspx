<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true" Inherits="akademik_app.Admin_UserAdd" Codebehind="UserDetails.aspx.cs" %>
...
<div class="CommonFormElement">
	<div class="CommonFormDescription">Отдел:</div>
	<div class="CommonFormData"><asp:ComboBox runat="server" ID="cbxServices" DataSourceID="dsServices" DataTextField="service_name" DataValueField="ID"></asp:ComboBox></div>
	<div class="ClearBoth"></div>  
</div>
<div class="CommonFormElement">
