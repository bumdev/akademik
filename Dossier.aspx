<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="Dossier.aspx.cs" Inherits="akademik_app.Dossier" %>
    ...
    <Pdf DefaultFontFamily="Arial Unicode MS" PageTopMargin="2" PageLeftMargin="2" PageRightMargin="2" PageBottomMargin="2"/>
        ...
        <MasterTableView EditMode="PopUp" IsFilterItemExpanded="True" EditFormSettings-PopUpSettings-Width="900px" DataKeyNames="ID" Width="100%" CommandItemDisplay="Top" AllowAutomaticUpdates="true" Name="Dossier"  AllowFilteringByColumn="true" >
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="projects" runat="server" HeaderText="Проекты"  AllowFiltering="false"></telerik:GridBoundColumn>
